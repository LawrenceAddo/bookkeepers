...
(function ($, undefined) {
  ...
  function ajax(options) {
    ...
    return function (query) {
      ...
      timeout = window.setTimeout(function () {
        ...
        const transport =
          options.transport || $.fn.select2.ajaxDefaults.transport;
        ...
        $.extend(params, {
          ...
          success: function (data) {
            ...
            const results = options.results(data, query.page);
    ...
    return function (query) {
      ...
      process = function (datum, collection) {
        ...
        if (datum.children) {
          group = {};
          for (attr in datum) {
            if (Object.prototype.hasOwnProperty.call(datum, attr)) {
  ...
  AbstractSelect2 = clazz(Object, {
    ...
    positionDropdown: function () {
      ...
      const height = this.container.outerHeight(false);
      let width = this.container.outerWidth(false);
      const dropHeight = $dropdown.outerHeight(false);
      ...
      let enoughRoomOnRight = dropLeft + dropWidth <= viewPortRight;
    ...
    loadMoreIfNeeded: function () {
      ...
      const offset = -1; // index of first element without data
    ...
    selectHighlighted: function (options) {
      ...
      const data = highlighted.closest(".select2-result").data("select2-data");
    ...
    getPlaceholderOption: function () {
      if (this.select) {
        const firstOption = this.select.children().first();
  ...
  SingleSelect2 = clazz(AbstractSelect2, {
    ...
    initContainer: function () {
      ...
      $("label[for='" + this.opts.element.attr("id") + "']").attr(
        "for",
