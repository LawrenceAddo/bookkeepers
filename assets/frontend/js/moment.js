...
(function (e) {
  ...
  function P(e) {
    const t = (this._data = {});
    let n = e.years || e.year || e.y || 0;
    let r = e.months || e.month || e.M || 0;
    const i = e.weeks || e.week || e.w || 0;
    let s = e.days || e.day || e.d || 0;
    let o = e.hours || e.hour || e.h || 0;
    let u = e.minutes || e.minute || e.m || 0;
    let a = e.seconds || e.second || e.s || 0;
    const f = e.milliseconds || e.millisecond || e.ms || 0;
  ...
  var f = /(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g;
  const l = /([0-9a-zA-Z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+)/gi;
  var c = /\d\d?/;
  var h = /\d{1,3}/;
  var p = /\d{3}/;
  var d = /\d{1,4}/;
  ...
  var x = /([\+\-]|\d\d)/gi;
  const T = "Month|Date|Hours|Minutes|Seconds|Milliseconds".split("|");
  const N = {
    Milliseconds: 1,
    Seconds: 1e3,
    Minutes: 6e4,
  ...
  var C = {};
  const k = "DDD w W M D d".split(" ");
  const L = "M D H h m s w W".split(" ");
  var A = {
    M: function () {
      return this.month() + 1;
    },
  ...
  (A.DDDD = O(A.DDD, 3)),
    ...
    (t.duration = function (e, n) {
      const r = t.isDuration(e);
      const i = typeof e === "number";
      const s = r ? e._data : i ? {} : e;
      let o;
      return (
        i && (n ? (s[n] = e) : (s.milliseconds = e)),
        (o = new P(s)),
        r &&
          Object.prototype.hasOwnProperty.call(e, "_lang") &&
          (o._lang = e._lang),
        o
      );
    }),
    ...
    (t.fn = D.prototype =
      {
        ...
        format: function (e) {
          const n = X(this, e || t.defaultFormat);
        ...
        diff: function (e, n, r) {
          const i = this._isUTC ? t(e).utc() : t(e).local();
          const s = (this.zone() - i.zone()) * 6e4;
          let o;
          let u;
          return (
            n && (n = n.replace(/s$/, "")),
        ...
        calendar: function () {
          const e = this.diff(t().startOf("day"), "days", !0);
          const n =
            e < -6
              ? "sameElse"
              : e < -1
