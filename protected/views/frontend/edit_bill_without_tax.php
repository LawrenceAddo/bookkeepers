...
$bill_details=$db->get_row('bills',array('id'=>$id));
$supplier_details=$db->get_row('contacts',array('id'=>$bill_details['supplier_id']));
$supplier_project=$db->get_all('assign_supplier_project',array('supplier'=>$bill_details['supplier_id']));
...
$item_price=unserialize($bill_details['item_price']);
$account=unserialize($bill_details['account']);
$item_description=unserialize($bill_details['item_description']);
...
//$total_tax=$bill_details['total_tax'];
...
if (isset($_POST['bill_submit']))
{
   ...
   // $item_id=$_POST['item'];
    ...
    $empt_fields = $fv->emptyfields(array('Customer Name'=>$supplier_id,
    ...
    $update=$db->update('bills',array('supplier_id'=>$supplier_id,
                                        'bill_date'=>$bill_date,
    ...
    if ($update){
        ...
        $event="Edit bill  (" . $bill_details['bill_number'] . ")";
            ...
            foreach ($project_id as $key=>$value){
                ...
                $update_tax=$db->update('tax_calculation',array('project_id'=>$project_t,
                                                                   //'tax_code'=>$taxcode_t,
                                                                    ...
                                                                    'ip_address'=>$ip_address,
                                                                    'visibility_status'=>'active'
                  ),array('genereted_from'=>'bill', 'genereted_from_id'=>$id));
            }

            }
            $display_msg= '<div class="alert alert-success">
                    		<i class="lnr lnr-smile"></i> <button class="close" data-dismiss="alert" type="button">×</button>Bill Save successfully.
                    		</div>';
            echo "<script>
                         setTimeout(function(){
   ...
   <div class="col-lg-12">
      ...
      <div class="widget-container fluid-height">
         ...
         <input type="hidden" value="<?php if (SELLING_APPROVAL=="enabled"){echo"draft";}else {echo "approved";}?>" name="status">
            <div class="row">
               <div class="col-lg-12">
                  <h4>Edit Bill &nbsp;&nbsp;&nbsp;<span class="label label-info">Status : <?php echo $bill_details['status'];?></span>
                   <a href="<?php echo $link->link('buying_bills',user);?>" class="btn btn-default pull-right">Back to List</a>
                         <a href="<?php echo $link->link('edit_bills',user,'&action_edit='.$id);?>" class="btn btn-default pull-right">Cancel</a>

                      <button class="btn btn-primary pull-right" type="submit" name="bill_submit">Save</button>
                    </h4>
                         ...
                         <div class="row">
                              <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                    	<input type="text" class="form-control" value="<?php echo $supplier_details['display_name'];?>" readonly>
                                    	<input type="hidden" class="form-control" value="<?php echo $supplier_details['id'];?>" name="supplier_id">
                                 ...
                                 <div class="form-group">
                                    <label class="control-label col-md-3"></label>
                                    <div class="col-md-7">
                                       <p><?php echo $supplier_details['postal_address'];?>
                                       <?php echo $supplier_details['postal_address_suburb'];?>
                                       <?php echo $supplier_details['postal_address_postcode'];?>
                                       </p>
                                    </div>
                                 </div>
                                 <br>
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                   <label class="control-label col-md-3"><?php echo $bill_details['bill_number'];?></label>
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                       <div class="input-group date datepicker col-md-12" data-date-autoclose="true" data-date-format="dd-mm-yyyy">
                                          <input class="form-control" type="text" name="bill_date" value="<?php echo $bill_details['bill_date'];?>"><span class="input-group-addon"><i class="lnr lnr-calendar-full "></i></span>
                                       </div>
                                    </div>
                                 </div>
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                       <input class="form-control" placeholder="" type="text" name="reference_code" value="<?php echo $bill_details['reference_code'];?>">
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                       <div class="input-group date datepicker col-md-12" data-date-autoclose="true" data-date-format="dd-mm-yyyy">
                                          <input class="form-control" type="text" name="due_date" value="<?php echo $bill_details['due_date'];?>"><span class="input-group-addon"><i class="lnr lnr-calendar-full "></i></span>
                                       </div>
                                    </div>
                                 </div>
                                 <!--  <div class="form-group">
...
<div class="input_fields_wrap_selling_estimate">
    ...
    <div class="col-md-2"><input class="form-control" type="text" value="<?php echo $item_price[$key];?>" name="item_price[]"  id="it_prc<?php echo $key;?>" required></div>
    <div class="col-md-2"><input class="form-control" type="text" value="<?php echo $item_description[$key];?>" name="description[]"></div>
    <div class="col-md-2"><input class="form-control" type="text" id="qty_<?php echo $key;?>"  value="<?php echo $item_qty[$key];?>" name="qty[]" value="" required> </div>
    <!-- <div class="col-md-1"><input class="form-control" type="text" id="item_total" name="total[]"></div> -->
    <!-- <div class="col-md-1"><input class="form-control" type="text" name="markup[]"></div> -->
                           ...
                           <div class="row">
                             ...
                             <div class="form-group">
                                 <label class="control-label">NOTE:</label>
                                    <textarea class="form-control" rows="6" cols="200" placeholder="Note to Customer" name="notes"><?php echo $bill_details['notes']?></textarea>
                                    </div>
                                 ...
                                 <div class="col-lg-6">
                                    ...
                                    <!-- <div class="form-group">
                                       ...
                                       <div class="col-md-1"></div>
                                       <div class="col-md-2">
                                          <div id="total_tax">0.00 <?php //echo number_format($total_tax,2,'.',',');?></div>
                                       </div>
                                    </div> -->
                                    <hr>
    		    ...
    		    $(add_button).click(function(e){ //on add input button click
    		        ...
    		        if(x < max_fields){ //max input box allowed
    		            ...
    		            $(wrapper).append('<div class="row">'+
    		            	    ...
    		            	    '<div class="col-md-2"><input class="form-control" type="text" id="qty_'+x+'" name="qty[]" required></div>'+
    		            	    /*'<div class="col-md-1">'+
    		            ...
    		            $("#it_prc"+x).keyup(function(){
    		            	...
    		            	var item_price=$(this).val();
	    		            var amount=item_price * item_qty; alert(amount);
