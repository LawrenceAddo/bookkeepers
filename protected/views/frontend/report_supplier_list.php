     ...
     $active_supplier=$db->get_all('contacts',array('visibility_status'=>'active','is_supplier'=>'yes'));
       if (is_array($active_supplier)){
           foreach($active_supplier as $supplier){
               ...
               {
                   $town= "Town : " .$supplier['postal_address_town'] ."<br>";
               }
               ...
               {
                   $postcode= "Postcode : " .$supplier['postal_address_postcode'] ."<br>";
               }
               /*  physical_address   */
               ...
               {
                   $physical_town= "Town : " .$supplier['physical_address_town'] ."<br>";
               }
               ...
               {
                   $physical_postcode= "Postcode : " .$supplier['physical_address_postcode'] ."<br>";
               }
