       ...
       $update=$db->update('estimates',array('customer_id'=>$customer_id,
		...
		//	'markup'=>$markup,
			...
			'created_date'=>$created_date,
       		'ip_address'=>$ip ),array('id'=>$edit_estimate_id));
            ...
            <div class="row">
               <div class="col-lg-12">
                  ...
                  <a href="<?php echo $link->link('selling_estimates',user);?>" class="btn btn-default pull-right">Back to List</a>
                     ...
                     <a href="<?php echo $link->link('edit_selling_estimates',user,'&action_edit='.$edit_estimate_id.'&id='.$id);?>" class="btn btn-default pull-right">Cancel</a>
                      <button class="btn btn-primary pull-right" type="submit" name="submit">Save</button></h4>

                  <div class="widget-container fluid-height clearfix">

                     <!--   <div class="btn-group pull-right">
                        <button class="btn btn-primary" type="submit" name="submit">Save & Close</button>
...
<div class="row">
   ...
   <div class="col-md-1">Tax code</div>
    ...
    <div class="col-md-1"><input class="form-control" type="text" id="qty_<?php echo $key;?>" value="<?php echo $item_qty[$key];?>" name="qty[]"></div>
    <div class="col-md-1"><input class="form-control" type="text" id="item_total<?php echo $key;?>" value="<?php echo $item_total[$key];?>" name="total[]" readonly></div>
  <div class="col-md-1">
    		...
    		<?php
    			if (is_array($all_supply_item_tax)){
    				foreach ($all_supply_item_tax as $item_tax1){?>
						<option <?php if ($item_tax_code[$key]==$item_tax1['tax_name']){echo "selected='selected'";}?> value="<?php echo $item_tax1['tax_name'];?>"><?php echo $item_tax1['tax_name'];?> @ <?php echo $item_tax1['tax_rate']?>%</option>
    		<?php }
    			}
    		?>
    	</select>
    ...
    <div class="col-md-1"><input class="form-control" type="text" id="taxx<?php echo $key;?>" value="<?php echo $item_tax[$key];?>" name="tax[]" readonly></div>
    <input class="form-control" type="hidden" id="taxx_perc<?php echo $key;?>" value="<?php echo $item_tax[$key];?>" name="tax1[]">
...
$("#qty_"+<?php echo $key;?>).keyup(function(){
	...
	$("#amount"+res[1]).val(parseFloat(itms_prc_new) + parseFloat(tax_amount));
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div class="row">'+
            	    ...
            	    '<div class="col-md-1"><input class="form-control" type="text" id="qty_'+x+'" name="qty[]"></div>'+
            	    ...
            	    '<input class="form-control" type="hidden" id="taxx_perc'+x+'" name="tax1[]">'+
