     ...
     $active_customer=$db->get_all('contacts',array('visibility_status'=>'active','is_customer'=>'yes'));
       if (is_array($active_customer)){
           foreach($active_customer as $customer){
               ...
               {
                   $town= "Town : " .$customer['postal_address_town'] ."<br>";
               }
               ...
               {
                   $postcode= "Postcode : " .$customer['postal_address_postcode'] ."<br>";
               }
             /*  physical_address   */
               ...
               {
                   $physical_town= "Town : " .$customer['physical_address_town'] ."<br>";
               }
               ...
               {
                   $physical_postcode= "Postcode : " .$customer['physical_address_postcode'] ."<br>";
               }
                ...
                $html.="<tr style='border-top:1px solid #ccc;'>
                      ...
                      <td> ".$mobile_number."</td>
                             ...
                             <td>".$website."</td>
                          <td>".$postal." ".$town." ".$suburb." ".$state." ".$postcode."</td>
                        <td>".$physical_postal." ".$physical_town." ".$physical_suburb." ".$physical_state." ".$physical_postcode."</td>
                      </tr>";
