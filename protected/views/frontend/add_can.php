...
<div class="row">
    ...
    <div class="col-md-1"><input class="form-control" type="text" name="item_price[]"  id="it_prc1" ></div>
    <div class="col-md-2"><input class="form-control" type="text" name="description[]"></div>
    <div class="col-md-1"><input class="form-control" type="text" id="qty" name="qty[]"></div>
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $("#qty"+x).keyup(function(){
            	...
            	var tax_percentage=$("#taxx_perc"+res_id).val();
...
$("#customer_id").change(function(){
	var id=$(this).val();
	location.href=window.location.pathname+'?user=add_can&id='+id;
});
</script>
