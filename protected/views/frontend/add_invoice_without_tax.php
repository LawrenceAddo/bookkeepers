...
<div class="row">
    ...
    <div class="col-md-2"><input class="form-control" type="text" name="item_price[]"  id="it_prc1" required></div>
    <div class="col-md-2"><input class="form-control" type="text" name="description[]"></div>
    <div class="col-md-2"><input class="form-control" type="text" id="qty" name="qty[]" value="" required></div>
...
$("#customer_id").change(function(){
	var id=$(this).val();
	location.href=window.location.pathname+'?user=add_invoice_without_tax&id='+id;
});
</script>