...
<body>
 ...
 <div class="col-submit">
    ...
    <label>
      Company type
       ...
       <select class="form-control" name="com_uen_type" style="height: 23px;" >
                     ...
                     <option <?php if ($com_uen_type=="SP")echo 'selected="selected"';?>  value="SP">Sole Proprietorship (SP)</option>
                     <option <?php if ($com_uen_type=="LP")echo 'selected="selected"';?>  value="LP"> Partnerships (LP)</option>
                     <option <?php if ($com_uen_type=="PLC")echo 'selected="selected"';?>  value="PLC">Private Company (PLC)</option>
                     <option <?php if ($com_uen_type=="LLC")echo 'selected="selected"';?>  value="LLC">Public Company (LLC)</option>
                     <option <?php if ($com_uen_type=="NGO")echo 'selected="selected"';?>  value="NGO">For-Impact Company (NGO)</option>
                     <option <?php if ($com_uen_type=="FC")echo 'selected="selected"';?>  value="FC">Foreign Entities(FC)</option>
               </select>
         </label>
  </div>
    <div class="col-4">
  ...
  <div class="col-4">
    <label>Tax reporting period (3 or 6 monthly)
